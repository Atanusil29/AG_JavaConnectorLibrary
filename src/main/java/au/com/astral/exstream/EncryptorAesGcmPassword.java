...
public class EncryptorAesGcmPassword {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	try {
    		String encryptedText = EncryptorAesGcmPassword.encrypt(args[0].getBytes(UTF_8), PASSWORD);
    		System.out.println("Encrypted text: " + encryptedText);
    		
    		String decryptedText = EncryptorAesGcmPassword.decrypt(encryptedText, PASSWORD);
